...
<head>
    ...
    <!-- Font Icon -->
    <link rel="stylesheet" href="<?php echo $path . '/fonts/material-icon/css/material-design-iconic-font.min.css' ?>">
        ...
        <div class="container">
            <div class="signup-content">
                ...
                <div class="signup-image">
                    <figure><img src="<?php echo $path . '/images/signup-image.jpg' ?>" alt="sing up image"></figure>
